...
const enterpriseFeatures = [
  {
    ...
    description:
      "SOC 2 Type II, ISO 27001, and HIPAA compliant infrastructure with end-to-end encryption and comprehensive audit logging.",
  },
  {
    icon: Lock,
    title: "Data Sovereignty",
    description:
      "Keep your data in India with our dedicated Indian data centers. Full compliance with DPDP Act and MeitY guidelines.",
  },
  {
    icon: Server,
    title: "Private Deployment",
    description:
      "Deploy Rivinity in your own VPC or on-premise infrastructure with air-gapped options for sensitive workloads.",
  },
  {
    icon: Users,
    title: "SSO & RBAC",
    description:
      "Enterprise single sign-on with SAML 2.0 and OIDC, plus granular role-based access control for teams of any size.",
  },
  {
    icon: Headphones,
    title: "Dedicated Support",
    description:
      "24/7 priority support with dedicated customer success manager, technical account manager, and SLA guarantees.",
  },
  {
    icon: FileCheck,
    title: "Custom Contracts",
    description:
      "Flexible licensing, custom terms, and enterprise procurement support including government vendor registration.",
  },
];
...
const useCases = [
  {
    ...
    description:
      "Deploy intelligent chatbots and voice agents handling millions of customer interactions in 22 Indian languages.",
    stats: "60% cost reduction",
  },
  {
    title: "Document Intelligence",
    description:
      "Extract, classify, and process documents at scale with OCR, NER, and intelligent summarization.",
    stats: "10x faster processing",
  },
  {
    title: "Code Generation",
    description:
      "Accelerate software development with AI-powered code generation, review, and documentation.",
    stats: "40% productivity boost",
  },
  {
    title: "Knowledge Management",
    description:
      "Build enterprise search and knowledge bases that understand context and deliver precise answers.",
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20">
        {/* Grid background — purely decorative, behind all content */}
        <Component />

        {/* All content must be relative z-10 to sit above the grid */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
                ...
                Deploy sovereign AI with enterprise-grade security, compliance,
                and support.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Built for the security, compliance, and scale requirements of
              large organizations
            </p>
          </motion.div>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Meeting the highest standards for security and regulatory
              compliance
            </p>
          </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
              Join India&apos;s leading organizations using Rivinity to build
