                ...
                <div className="flex gap-1.5 flex-wrap mb-3">
                  {categories.map((c) => (
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-full text-[10px] font-medium transition-all ${c.id === "all" ? "bg-accent text-primary-foreground" : "bg-muted/50 text-muted-foreground/60 hover:bg-muted"}`}
                    >
                      {c.label}
                    </button>
                  ))}
