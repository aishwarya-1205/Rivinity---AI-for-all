...
export function SecuritySection() {
  return (
    <SectionWrapper className="bg-background" id="security">
      <motion.div
      ...
      >
        {certifications.map((cert, index) => (
          ...
          >
            <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-gradient-to-br from-accent/5 to-highlight/5 border border-border flex items-center justify-center mb-4 group-hover:border-accent/50 transition-colors duration-300">
