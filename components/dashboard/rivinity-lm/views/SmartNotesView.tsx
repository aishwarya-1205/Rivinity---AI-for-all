          ...
          {notes.map(n => (
            ...
            >
              <div className="flex items-center gap-2">
                <FileText className="w-3.5 h-3.5 text-accent/60 shrink-0" />
        ...
        <div className="flex-1 glass rounded-2xl border border-glass p-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-[200px_1fr] gap-px bg-border/40 rounded-xl overflow-hidden">
            <div className="bg-accent/5 p-4">
              <p className="text-[10px] font-semibold text-accent/60 uppercase tracking-wider mb-2">Cue / Questions</p>
