  ...
  return (
    <div className="max-w-[600px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="text-[12px] font-semibold text-accent">Score: {score}</span>
      </div>
      ...
      {showExplanation && (
        <div className="glass rounded-xl border border-glass p-4 mb-6 animate-float-in">
          <p className="text-[10px] font-semibold text-accent/60 uppercase tracking-wider mb-2">Explanation</p>
