...
const tools = [
  { id: "contextual-chat", icon: MessageSquare, label: "Chat", color: "text-accent" },
  { id: "smart-notes", icon: StickyNote, label: "SmartNotes", color: "text-accent" },
  ...
  { id: "voice-transcribe", icon: FileAudio, label: "Transcribe", color: "text-accent" },
  { id: "homework-planner", icon: CalendarCheck, label: "Homework", color: "text-accent" },
  { id: "exam-lab", icon: GraduationCap, label: "ExamLab", color: "text-accent" },
  { id: "debate", icon: Swords, label: "Debate", color: "text-accent" },
  { id: "study-companion", icon: Bot, label: "Companion", color: "text-accent" },
  { id: "data-analyst", icon: BarChart3, label: "Analyst", color: "text-accent" },
];
