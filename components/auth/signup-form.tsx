...
// MagicUI-style side cannons confetti
...
const SignUpForm = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      setIsSuccess(true);
      fireSideCannons(); // 🎉 MagicUI side cannons
    }, 1000);
  };
    ...
    <div className="w-full max-w-sm bg-gradient-to-b from-sky-50/50 to-white dark:from-gray-900 dark:to-black rounded-3xl shadow-2xl shadow-blue-500/10 p-8 flex flex-col items-center border border-blue-100 dark:border-gray-800 transition-all duration-300">
      ...
      <form onSubmit={handleSignUp} className="w-full flex flex-col gap-4">
        ...
        <div className="flex gap-3 w-full">
          <button
            type="button"
            className="flex items-center justify-center h-12 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors flex-1 shadow-sm"
          >
            <img
